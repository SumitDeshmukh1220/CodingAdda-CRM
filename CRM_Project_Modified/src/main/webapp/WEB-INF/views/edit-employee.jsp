...
<head>
  <meta charset="UTF-8">
  <title>Edit Employee – Coding Adda</title>
    ...
    <div class="card-dark" style="max-width:560px;margin:0 auto;">
      ...
      <form:form action="updateEmpForm" method="post" modelAttribute="modelEmpAttr">
        <div class="mb-3">
          ...
          <form:input path="name" placeholder="Enter full name" cssClass="form-control" value="${model_emp.getName()}"/>
        ...
        <div class="mb-3">
          ...
          <form:input path="password" placeholder="Enter password" cssClass="form-control" value="${model_emp.getPassword()}"/>
          <form:errors path="password" cssClass="error_message_design"/>
        </div>
        <div class="mb-4">
          <label class="form-label">Phone Number</label>
          <form:input path="phoneno" placeholder="Enter phone number" cssClass="form-control" value="${model_emp.getPhoneno()}"/>
